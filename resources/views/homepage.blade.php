...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="{{asset('seotech-html/css/bootstrap.css')}}" />

  <!-- fonts style -->
  <link href="https://fonts.googleapis.com/css?family=Poppins:400,600,700&display=swap" rel="stylesheet">
  <!-- Custom styles for this template -->
  <link href="{{asset('seotech-html/css/style.css')}}" rel="stylesheet" />
  <!-- responsive style -->
  <link href="{{asset('seotech-html/css/responsive.css')}}" rel="stylesheet" />
</head>
...
{{--<section class="team_section layout_padding2-bottom">
 ...
 {{-- <div class="footer_bg">
  ...
  <script type="text/javascript" src="{{asset('seotech-html/js/jquery-3.4.1.min.js')}}"></script>
  <script type="text/javascript" src="{{asset('seotech-html/js/bootstrap.js')}}"></script>
  <script type="text/javascript" src="{{asset('seotech-html/js/custom.js')}}"></script>
